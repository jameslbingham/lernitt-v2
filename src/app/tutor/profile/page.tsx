...
export default async function TutorProfilePage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto font-sans">
      <h1 className="text-3xl font-bold mb-6">Tutor Dashboard: {tutor.name}</h1>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-dashed border-gray-400 text-center">
        ...
        <p className="text-sm text-gray-600 mb-4">Click below to simulate a $25 lesson (Adds $21.25 to balance).</p>
